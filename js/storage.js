...
const SEED_MENU = {
    ...
    1: { label: '月曜日', status: 'push（胸メイン）', exercises: [
        ...
        { id: '2', name: 'インクラインダンベルプレス', weight: '28', sets: '3', repsRange: '6-10', restMinutes: 2 },
        { id: '3', name: 'ディップス', weight: '9', sets: '3', repsRange: '8-12', restMinutes: 2 },
        { id: '4', name: 'ショルダープレスマシン', weight: '25', sets: '4', repsRange: '8-12', restMinutes: 2 },
    ...
    2: { label: '火曜日', status: 'pull（広がり）', exercises: [
        ...
        { id: '24', name: 'アイソラテラルロー', weight: '80', sets: '3', repsRange: '8-12', restMinutes: 2 },
    ...
    5: { label: '金曜日', status: 'push（肩メイン）', exercises: [
        { id: '51', name: 'ダンベルショルダープレス', weight: '26', sets: '3', repsRange: '5-8', restMinutes: 3 },
        { id: '52', name: 'ベンチプレス', weight: '67.5', sets: '2', repsRange: '6', restMinutes: 3 },
        { id: '53', name: 'マシンサイド', weight: '11', sets: '1', repsRange: '12-20', restMinutes: 1 },
        { id: '54', name: 'ダンベルサイドレイズ', weight: '10', sets: '3', repsRange: '12-20', restMinutes: 1 },
